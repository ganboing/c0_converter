...
void init0()
{
    ...
    {
        trigger[i/(10)*512] = 0;
        do{struct __attribute__((packed)){unsigned long cnt;struct __attribute__((packed)){char* base;long len;} ranges[5];} runner_using;{runner_using.cnt = 5;runner_using.ranges[0].base = ((char*)( x));runner_using.ranges[0].len = ((char*)(&(( x)[ i + (10)]))-(char*)(&(( x)[i])));runner_using.ranges[1].base = ((char*)( y));runner_using.ranges[1].len = ((char*)(&(( y)[ i + (10)]))-(char*)(&(( y)[i])));runner_using.ranges[2].base = ((char*)( z));runner_using.ranges[2].len = ((char*)(&(( z)[ i + (10)]))-(char*)(&(( z)[i])));runner_using.ranges[3].base = ((char*)( w));runner_using.ranges[3].len = ((char*)(&(( w)[ i + (10)]))-(char*)(&(( w)[i])));runner_using.ranges[4].base = ((char*)( trigger));runner_using.ranges[4].len = ((char*)(&(( trigger)[ (i/(10)+1)*512]))-(char*)(&(( trigger)[i/(10)*512])));}struct __attribute__((packed)){unsigned long cnt;} runner_watching;{runner_watching.cnt = 0;}extern void l0_syscall_spawn(const char*, const char*,const char*);extern void newr0(void);l0_syscall_spawn((char*)newr0, (char*)&runner_using, (char*)&runner_watching);{ init_runner(i, i + (10))
            ;}}while(0)
;
    }
...
void init0_in_pmem()
{
    ...
    for(i = 0; i < (10); i = i + (10))
    {
        ...
        do{struct __attribute__((packed)){unsigned long cnt;struct __attribute__((packed)){char* base;long len;} ranges[7];} runner_using;{runner_using.cnt = 7;runner_using.ranges[0].base = ((char*)( x));runner_using.ranges[0].len = ((char*)(&(( x)[ i + (10)]))-(char*)(&(( x)[i])));runner_using.ranges[1].base = ((char*)( y));runner_using.ranges[1].len = ((char*)(&(( y)[ i + (10)]))-(char*)(&(( y)[i])));runner_using.ranges[2].base = ((char*)( z));runner_using.ranges[2].len = ((char*)(&(( z)[ i + (10)]))-(char*)(&(( z)[i])));runner_using.ranges[3].base = ((char*)( w));runner_using.ranges[3].len = ((char*)(&(( w)[ i + (10)]))-(char*)(&(( w)[i])));runner_using.ranges[4].base = ((char*)( trigger));runner_using.ranges[4].len = ((char*)(&(( trigger)[ (i/(10)+1)*512]))-(char*)(&(( trigger)[i/(10)*512])));runner_using.ranges[5].base = ((char*)(&( pmem_in
            ...
            ));runner_using.ranges[6].base = ((char*)( pmem_in));runner_using.ranges[6].len = ((char*)(&(( pmem_in)[ 4*(i + (10))]))-(char*)(&(( pmem_in)[4*i])));}struct __attribute__((packed)){unsigned long cnt;} runner_watching;{runner_watching.cnt = 0;}extern void l0_syscall_spawn(const char*, const char*,const char*);extern void newr0(void);l0_syscall_spawn((char*)newr0, (char*)&runner_using, (char*)&runner_watching);{ init_runner_pmem(i, i + (10))
            ;}}while(0)
;
    }
...
void main()
{
    do{struct __attribute__((packed)){unsigned long cnt;struct __attribute__((packed)){char* base;long len;} ranges[2];} runner_using;{runner_using.cnt = 2;runner_using.ranges[0].base = ((char*)( trigger));runner_using.ranges[0].len = ((char*)(&(( trigger)[ ((10)/(10)+1)*512]))-(char*)(&(( trigger)[0])));runner_using.ranges[1].base = ((char*)(&(
           ...
           pmem_in));}struct __attribute__((packed)){unsigned long cnt;} runner_watching;{runner_watching.cnt = 0;}extern void l0_syscall_spawn(const char*, const char*,const char*);extern void newr0(void);l0_syscall_spawn((char*)newr0, (char*)&runner_using, (char*)&runner_watching);{ init0_in_pmem() ;}}while(0)
;
    do{void l0_syscall_commit(void) __attribute__((noreturn)); l0_syscall_commit();}while(0);
}
